...
public class KhmxbDto {
	 ...
	 * 报关费 收入
	 */	
	private Float bgf_sr;//
	
	/**
	 * 报关费 成本
	 */
	private Float bgf_cb;//
	
	/**
	 * 广建费 收入
	 */	
	private Float guangjf_sr;//
	/**
	 * 广建费 成本
	 */
	private Float guangjf_cb;//
	
	/**
	 * 国检费 收入
	 */	
	private Float goujf_sr;//
	/**
	 * 国检费 成本
	 */
	private Float goujf_cb;//
	
	/**
	 * 商检费 收入
	 */	
	private Float sjf_sr;//
	/**
	 * 商检费 成本
	 */
	private Float sjf_cb;//
	
	/**
	 * 续页费 收入
	 */	
	private Float xyf_sr;//
	/**
	 * 续页费 成本
	 */
	private Float xyf_cb;//
	
	/**
	 * 连柜费 收入
	 */	
	private Float lgf_sr;//
	/**
	 * 连柜费 成本
	 */
	private Float lgf_cb;//
	
	/**
	 * 拖车费 收入
	 */	
	private Float tcf_sr;//
	/**
	 * 拖车费 成本
	 */
	private Float tcf_cb;//
	
	/**
	 * 扫描费 收入
	 */	
	private Float smf_sr;//
	/**
	 * 扫描费 成本
	 */
	private Float smf_cb;//
	
	/**
	 * 查柜费 收入
	 */	
	private Float cgf_sr;//
	/**
	 * 查柜费 成本
	 */
	private Float cgf_cb;//
	
	/**
	 * 熏蒸费 收入
	 */	
	private Float xzf_sr;//
	/**
	 * 熏蒸费 成本
	 */
	private Float xzf_cb;//
	 ...
	 * 信用证费 收入
	 */	
	private Float xyzf_sr;//
	/**
	 * 信用证费 成本
	 */
	private Float xyzf_cb;//
	
	/**
	 * 产地证费 收入
	 */	
	private Float cdzf_sr;//
	/**
	 * 产地证费 成本
	 */
	private Float cdzf_cb;//
	
	/**
	 * 空白单证费 收入
	 */	
	private Float kbdzf_sr;//
	/**
	 * 空白单证费 成本
	 */
	private Float kbdzf_cb;//
	
	/**
	 * 快递费 收入
	 */	
	private Float kdf_sr;//
	/**
	 * 快递费 成本
	 */
	private Float kdf_cb;//
	
	/**
	 * 驳船费 收入
	 */	
	private Float bcf_sr;//
	/**
	 * 驳船费 成本
	 */
	private Float bcf_cb;//
	
	/**
	 * 封条费 收入
	 */	
	private Float ftf_sr;//
	/**
	 * 封条费 成本
	 */
	private Float ftf_cb;//
	
	/**
	 * 仓单费 收入
	 */	
	private Float cdf_sr;//
	/**
	 * 仓单费 成本
	 */
	private Float cdf_cb;//
	
	/**
	 * 过磅费 收入
	 */	
	private Float gbf_sr;//
	/**
	 * 过磅费 成本
	 */
	private Float gbf_cb;//
	
	/**
	 * 换证凭条费 收入
	 */	
	private Float hzptf_sr;//
	/**
	 * 换证凭条费 成本
	 */
	private Float hzptf_cb;//
	...
	public Float getGbf_sr() {
		return gbf_sr;
	}

	public void setGbf_sr(Float gbf_sr) {
		this.gbf_sr = gbf_sr;
	}

	public Float getGbf_cb() {
		return gbf_cb;
	}

	public void setGbf_cb(Float gbf_cb) {
		this.gbf_cb = gbf_cb;
	}
	...
	public void setYwy(Float ywy) {
		this.ywy = ywy;
	}

	public Float getDlfbz() {
		return dlfbz;
	}

	public void setDlfbz(Float dlfbz) {
		this.dlfbz = dlfbz;
	}
