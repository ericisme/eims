...
public class FkzfController extends SimpleManageController<Fkzf, FkzfService>{
	...
	public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		for(Fkzf fkzk : list){			
			...
			wsheet.addCell(new Label(5,i,StringUtil.formatFloat(fkzk.getBgje()), setCellFormat()));
			wsheet.addCell(new Label(6,i,StringUtil.formatFloat(fkzk.getBgf()), setCellFormat()));
			wsheet.addCell(new Label(7,i,StringUtil.formatFloat(fkzk.getGjf()), setCellFormat()));
			wsheet.addCell(new Label(8,i,StringUtil.formatFloat(fkzk.getGj()), setCellFormat()));
			wsheet.addCell(new Label(9,i,StringUtil.formatFloat(fkzk.getSjf()), setCellFormat()));
			wsheet.addCell(new Label(10,i,StringUtil.formatFloat(fkzk.getXyf()), setCellFormat()));
			wsheet.addCell(new Label(11,i,StringUtil.formatFloat(fkzk.getLgf()), setCellFormat()));
			wsheet.addCell(new Label(13,i,StringUtil.formatFloat(fkzk.getSmf()), setCellFormat()));
			wsheet.addCell(new Label(14,i,StringUtil.formatFloat(fkzk.getCgf()), setCellFormat()));
			wsheet.addCell(new Label(15,i,StringUtil.formatFloat(fkzk.getXzf()), setCellFormat()));
			wsheet.addCell(new Label(16,i,StringUtil.formatFloat(fkzk.getJq()), setCellFormat()));
			wsheet.addCell(new Label(17,i,StringUtil.formatFloat(fkzk.getXyzf()), setCellFormat()));
			wsheet.addCell(new Label(18,i,StringUtil.formatFloat(fkzk.getCdzf()), setCellFormat()));
			wsheet.addCell(new Label(19,i,StringUtil.formatFloat(fkzk.getKbdzf()), setCellFormat()));
			wsheet.addCell(new Label(20,i,StringUtil.formatFloat(fkzk.getKdf()), setCellFormat()));
			wsheet.addCell(new Label(21,i,StringUtil.formatFloat(fkzk.getBcf()), setCellFormat()));
			wsheet.addCell(new Label(22,i,StringUtil.formatFloat(fkzk.getFtf()), setCellFormat()));
			wsheet.addCell(new Label(23,i,StringUtil.formatFloat(fkzk.getCdf()), setCellFormat()));
			wsheet.addCell(new Label(24,i,StringUtil.formatFloat(fkzk.getGpf()), setCellFormat()));
			wsheet.addCell(new Label(25,i,StringUtil.formatFloat(fkzk.getHzptf()), setCellFormat()));			
			wsheet.addCell(new Label(26,i,StringUtil.formatFloat(fkzk.getQt()), setCellFormat()));			
			wsheet.addCell(new Label(27,i,fkzk.getZfrq(), setCellFormat()));
			wsheet.addCell(new Label(28,i,StringUtil.formatFloat(fkzk.getZfje()), setCellFormat()));
			wsheet.addCell(new Label(29,i,StringUtil.formatFloat(fkzk.getWfje()), setCellFormat()));			
			i++;
		}
		...
		wsheet.addCell(new Label(6,i,StringUtil.formatFloat(sum_bgje), setCellFormat()));
		wsheet.addCell(new Label(7,i,StringUtil.formatFloat(sum_bgf), setCellFormat()));
		wsheet.addCell(new Label(8,i,StringUtil.formatFloat(sum_gjf), setCellFormat()));
		wsheet.addCell(new Label(9,i,StringUtil.formatFloat(sum_gj), setCellFormat()));
		wsheet.addCell(new Label(10,i,StringUtil.formatFloat(sum_sjf), setCellFormat()));
		wsheet.addCell(new Label(11,i,StringUtil.formatFloat(sum_xyf), setCellFormat()));
		wsheet.addCell(new Label(12,i,StringUtil.formatFloat(sum_lgf), setCellFormat()));
		...
		wsheet.addCell(new Label(28,i,StringUtil.formatFloat(sum_zfje), setCellFormat()));
		wsheet.addCell(new Label(29,i,StringUtil.formatFloat(sum_wfje), setCellFormat()));
